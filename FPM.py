        ...
        for i in range(1, n):
            ...
            if param == "-d":
                ...
                if DataSet == "mushroom.txt":
                    store_data = pd.read_csv('C:\\Users\\User\\Downloads\\data\\mushroom.txt', sep=" ",header=None)
                    store_data.fillna(0, inplace=True)
                    store_data.head()
                    store_data = store_data.astype(int)
                elif DataSet == "chess.txt":
                    store_data = pd.read_csv('C:\\Users\\User\\Downloads\\data\\chess.txt', sep=" ",header=None)
                    store_data.fillna(0, inplace=True)
                    store_data.head()
                    store_data = store_data.astype(int)
                elif DataSet == "kosarak.txt":
                    store_data = pd.read_csv('C:\\Users\\User\\Downloads\\data\\kosarak.txt', header=None)
                    store_data.fillna(0, inplace=True)
                    store_data.head()
                    store_data = store_data.astype(int)
                elif DataSet == "retail.txt":
                    store_data = pd.read_csv('C:\\Users\\User\\Downloads\\data\\retail.txt', header=None)
                    store_data.fillna(0, inplace=True)
                    store_data.head()
                    store_data = store_data.astype(int)
                else:
                    DataSet == "toy.txt"
                    store_data = pd.read_csv('C:\\Users\\User\\Downloads\\data\\toy.txt', header=None)
                    store_data.fillna(0, inplace=True)
                    store_data.head()
                    store_data = store_data.astype(int)
                    print(store_data)
            ...
            if param == "-pf":
                ...
                if patternFileName == "PatternForFP.txt":
                    file_path = 'C:\\Users\\User\\PycharmProjects\\pythonProject5\\PatternForFP.txt'
                    ...
                    file_path = 'C:\\Users\\User\\PycharmProjects\\pythonProject5\\PatternForAP.txt'
                    sys.stdout = open(file_path, "w")
                    Apriori()
            ...
            if param == "-o":
                ...
                if outputFileName == "Apriori.csv":
                    file_path = 'C:\\Users\\User\\PycharmProjects\\pythonProject5\\Apriori.csv'
                    sys.stdout = open(file_path, "w"  )
                    Apriori_o()

                elif outputFileName == "FP.csv":
                    file_path = 'C:\\Users\\User\\PycharmProjects\\pythonProject5\\FP.csv'
                    sys.stdout = open(file_path, "w")
                    FPGrowth_o()
